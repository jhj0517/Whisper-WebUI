...
from modules.utils.files_manager import load_yaml, MEDIA_EXTENSION_GRADIO
            ...
            with Translate(self.i18n):  # Add `lang = lang` here to test dynamic change of the languages.
                ...
                with gr.Tabs():
                    with gr.TabItem(_("File")):  # tab1
                        with gr.Column():
                            input_file = gr.Files(type="filepath", label=_("Upload File here"), file_types=MEDIA_EXTENSION_GRADIO)
